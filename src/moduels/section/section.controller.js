...
sectionRouter.patch("/slider/:sliderId", multerUpload.single("image"), validator(schemas.createSliderSchema) , asyncHandler(ss.updateSlider))
...
sectionRouter.put("/:page/:section", asyncHandler(ss.updateSection))
